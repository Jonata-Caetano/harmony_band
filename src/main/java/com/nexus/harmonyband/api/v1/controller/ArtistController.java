...
public class ArtistController {
    ...
    @GetMapping
    public Page<ArtistModel> getAllArtists(@PageableDefault(size = 10) Pageable pageable) {
        Page<ArtistEntity> artistsPage = service.getAllArtists(pageable);
        return artistsPage.map(artistModelAssembler::toModel);
    }
